...
# plt.hist(df['Survived'].values, bins=2)
# plt.xlabel('Survived or not')
# plt.ylabel('number records')
# plt.show()

# plt.hist(df['Pclass'].values, bins=3)
# plt.xlabel('Class distribution')
# plt.ylabel('number records')
# plt.show()

# plt.hist(df['Fare'].values, bins=300)
# plt.xlabel('Class distribution')
# plt.ylabel('number records')
# plt.show()

# plt.hist(df['Age'].values, bins=300)
# plt.xlabel('Class distribution')
# plt.ylabel('number records')
# plt.show()


# plt.hist(np.log(df['Age'].values + 1), bins=100)
# plt.xlabel('Class distribution')
# plt.ylabel('number records')
# plt.show()
# # High peak on log age

# # Contains a negative number
# df['log_fare'] = np.log(df['Fare'].values + 1.01)
# plt.hist(np.log(df['log_fare'].values), bins=50)
# plt.xlabel('Class distribution')
# plt.ylabel('number records')
# plt.show()
...
model = RandomForestRegressor(warm_start=True, verbose=1,
                              n_estimators=40,
                              min_samples_leaf=1,
                              n_jobs=2)
